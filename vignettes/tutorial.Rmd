...
[MotrpacRatTraining6mo vignette](https://motrpac.github.io/MotrpacRatTraining6mo/) for examples. 
...
[here](https://github.com/MoTrPAC/MotrpacRatTraining6moData/blob/main/README.md#access-epigenomics-data-through-google-cloud-storage).   
...
[here](https://github.com/MoTrPAC/MotrpacRatTraining6moData/blob/main/README.md#explore-available-data-objects). 
...
# Perform PCA
skmgn_pca = prcomp(t(TRNSCRPT_SKMGN_NORM_DATA[,sample_ids]))
...
RNA-seq and proteomics data to overlapping BIDs and genes. For cases where multiple feature IDs map to the same gene, take the average value 
per BID.  
```{r}
