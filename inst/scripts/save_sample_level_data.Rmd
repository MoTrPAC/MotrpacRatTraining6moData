...
### Handle METAB normalized data separately 

#### Single normalized data table

Because there are multiple viallabels per animal per tissue for METAB data,
make a single normalized data table where column names are PID instead of viallabel. 

Also save METAB metadata and a feature ID map to map across METAB datasets 
(sample-level data, refmet, metabolite_name, DA tables, graphical analysis results). 
...
David is separately adding the raw data to the GCS bucket. 
```{r}
# rrbs
